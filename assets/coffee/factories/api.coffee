angular.module('PokemonClub').factory('API', ['$http', ($http) ->
  ...
  return {
    ...
    pokemon_in_location: (id) ->
      ...
      ###
      $http.get(url + "location/#{id}/pokemon/")
    ...
    login: (data) ->
      ...
      if(data.userName != '' && data.password != '')
        $http.post(url + 'user/sign-in/', data)
      else
        console.log('failed')
        return
    ...
    pokemon_evo_detail: (id, method) ->
      ...
      ###
      $http.get(url + "pokemon/#{id}/evo/#{method}/")
    ...
    pokemon_learn_set: (id, level) ->
      ...
      ###
      $http.get(url + "pokemon/#{id}/learnset/#{level}/")
    ...
    old_pokemon_learn_set: (id, level) ->
      ...
      @return: A promise for a list of up to four moves that the given
               ...
               data.
      ###
      $http.get(url + "pokemon/#{id}/level/#{level}/")
    ...
    user_add_item: (id, data) ->
      ...
      ###
      $http.post(url + "user/#{id}/item", data)
    ...
    user_item_detail: (id, item_id) ->
      ...
      ###
      $http.get(url + "user/#{id}/item/#{item_id}/")
    ...
    update_user_item: (id, item_id, data) ->
      ...
      @return: A promise for the success or failure state of the
               transaction.
      ###
      $http.patch(url + "user/#{id}/item/#{item_id}/", data)
    ...
    delete_user_item: (id, item_id) ->
      ...
      @return: A promise for the success or failure state of the
               transaction.
      ###
      $http.delete(url + "user/#{id}/item/#{item_id}/")
    ...
    add_badge: (id, data) ->
      ...
      @return: A promise for the success or failure state of the
               transaction.
      ###
      $http.post(url + "user/#{id}/badge/", data)
    ...
    add_pokedex_entry: (id, data) ->
      ...
      @return: A promise for the success or failure state of the
               transaction.
      ###
      $http.post(url + "user/#{id}/pokedex/", data)
    ...
    user_pokemon_detail: (id, pokemon_id) ->
      ...
      @return: A promise for the detail of the specified pokemon of the
               specified user.
      ###
      $http.get(url + "user/#{id}/pokemon/#{pokemon_id}/")
    ...
    catch_pokemon: (id, data) ->
      ...
      $http.post(url + "user/#{id}/pokemon/", data)
    ...
    update_user_pokemon: (id, pokemon_id, data) ->
      ...
      $http.patch(url + "user/#{id}/pokemon/#{pokemon_id}/", data)
    ...
    release_user_pokemon: (id, pokemon_id) ->
      ...
      @return: A promise for the success or failure state of the
               transaction.
      ###
      $http.delete(url + "user/#{id}/pokemon/#{pokemon_id}/")
    }
])
